...
namespace WebApi2Book.Web.Api.Tests.Controllers.V1
{
    public class TasksControllerDependencyBlockMock : Mock<ITasksControllerDependencyBlock>
    {
        ...
        public Mock<IAddTaskMaintenanceProcessor> AddTaskMaintenanceProcessorMock
        {
            get
            {
                return _addTaskMaintenanceProcessorMock ?? (_addTaskMaintenanceProcessorMock = new Mock<IAddTaskMaintenanceProcessor>());
            }
        ...
        public Mock<ITaskByIdInquiryProcessor> TaskByIdInquiryProcessorMock
        {
            get
            {
                return _taskByIdInquiryProcessorMock ?? (_taskByIdInquiryProcessorMock = new Mock<ITaskByIdInquiryProcessor>());
            }
        ...
        public Mock<IUpdateTaskMaintenanceProcessor> UpdateTaskMaintenanceProcessorMock
        {
            get
            {
                return _updateTaskMaintenanceProcessorMock ?? (_updateTaskMaintenanceProcessorMock = new Mock<IUpdateTaskMaintenanceProcessor>());
            }
        ...
        public Mock<IPagedDataRequestFactory> PagedDataRequestFactoryMock
        {
            get
            {
                return _pagedDataRequestFactoryMock ?? (_pagedDataRequestFactoryMock = new Mock<IPagedDataRequestFactory>());
            }
        ...
        public Mock<IAllTasksInquiryProcessor> AllTasksInquiryProcessorMock
        {
            get
            {
                return _allTasksInquiryProcessorMock ?? (_allTasksInquiryProcessorMock = new Mock<IAllTasksInquiryProcessor>());
            }
