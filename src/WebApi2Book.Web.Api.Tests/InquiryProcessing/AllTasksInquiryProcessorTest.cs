...
namespace WebApi2Book.Web.Api.Tests.InquiryProcessing
{
    ...
    public class AllTasksInquiryProcessorTest
    {
        ...
        public void SetUp()
        {
            ...
            _inquiryProcessor = new AllTasksInquiryProcessorTestDouble(_allTasksQueryProcessorMock.Object, _autoMapperMock.Object, _taskLinkServiceMock.Object, _commonLinkServiceMock.Object);
        }
        ...
        private class AllTasksInquiryProcessorTestDouble : AllTasksInquiryProcessor
        {
            ...
            public Func<PagedTaskDataInquiryResponse, string> GetCurrentPageQueryStringTestDouble
            {
                get;
                set;
            }

            public Func<PagedTaskDataInquiryResponse, string> GetNextPageQueryStringTestDouble
            {
                get;
                set;
            }

            public Func<PagedTaskDataInquiryResponse, string> GetPreviousPageQueryStringTestDouble
            {
                get;
                set;
            }
            ...
            {
                return GetCurrentPageQueryStringTestDouble == null ? base.GetCurrentPageQueryString(inquiryResponse) : GetCurrentPageQueryStringTestDouble(inquiryResponse);
            }

            public override string GetNextPageQueryString(PagedTaskDataInquiryResponse inquiryResponse)
            {
                return GetNextPageQueryStringTestDouble == null ? base.GetNextPageQueryString(inquiryResponse) : GetNextPageQueryStringTestDouble(inquiryResponse);
            }

            public override string GetPreviousPageQueryString(PagedTaskDataInquiryResponse inquiryResponse)
            {
                return GetPreviousPageQueryStringTestDouble == null ? base.GetPreviousPageQueryString(inquiryResponse)
        ...
        public void AddLinksToInquiryResponse_adds_page_links()
        {
            ...
            _commonLinkServiceMock.Verify(
                x => x.AddPageLinks(inquiryResponse, currentPageQueryString, previousPageQueryString, nextPageQueryString));
        }
